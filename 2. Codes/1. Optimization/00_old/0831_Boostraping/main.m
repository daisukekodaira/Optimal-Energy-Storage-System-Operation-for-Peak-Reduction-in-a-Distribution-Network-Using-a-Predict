...
stats = bootstrp(n_sample,@(x)[mean(x) std(x)], sample);
mean_bstr = stats(:,1);
std_bstr = stats(:,2);
...
figure;
histogram(std_smp,'Normalization','probability')
title('Standard Deviation of Smaples')

figure;
histogram(mean_smp,'Normalization','probability')
title('Mean of Smaples')

figure;
histogram(mean_bstr,'Normalization','probability')
title('Mean of boostrapping data')

figure;
histogram(std_bstr,'Normalization','probability')
